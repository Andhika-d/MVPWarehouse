...
class StockRequestExport
{
    ...
    {
        $tempFile = tempnam(sys_get_temp_dir(), 'req-export');
        if ($tempFile === false) {
        ...
        $sheetRows = [];
        $sheetRows[] = ['ID', 'Pemohon', 'Barang', 'Jumlah', 'Satuan', 'Prioritas', 'Status', 'Tanggal', 'Catatan Review'];
...
<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties"
  ...
  <dc:title>Permintaan Barang</dc:title>
