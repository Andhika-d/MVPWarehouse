<x-layout>
    ...
    <div class="space-y-6">
        ...
        <!-- ================= SEARCH & FILTER ================= -->
        <form id="historyFilters" method="GET" action="/hr/history" data-auto-filter class="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2 shrink-0">
                ...
                @if(request()->filled('search') || $period || (request()->filled('status') && request('status') !== 'all'))
    ...
    <x-slot:modals>
        <x-period-filter-modal :period="$period" form-id="historyFilters" />
